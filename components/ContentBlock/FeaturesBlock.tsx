...
export default function FeaturesBlock() {
	return (
		<Flex flexDirection={"column"} alignItems="center">
			<Feature
				MainTitle="Omni-Chain"
				SecondTitle="Chain Integration"
				instruction="Support EVM & non-EVM chains via XIBC protocol"
				logoSrc={omniChainLogo}
			/>
			<Feature
				MainTitle="Alternative Cross -"
				SecondTitle="Chain Approach"
				instruction="State Relay - Trustless Oracle TSS - Cost effective"
				logoSrc={alternativeCrossLogo}
			/>
			<Feature
				MainTitle="Dapp -"
				SecondTitle="Interoperability"
				instruction="Non-invasive SDK for seamless dApp integration"
				logoSrc={dappLogo}
			/>
		</Flex>
	)
			...
			<Flex height="100%" justifyContent={"space-between"} padding="60px 0">
				...
				<Flex flexDirection={"column"} alignItems="end">
					<Flex
						...
						alignItems={"start"}
					>
						<Image src={logoSrc} alt="omni-logo"></Image>
					</Flex>
					<Text
						sx={{
							maxHeight: "20%",
